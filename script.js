...
let recentSearches = JSON.parse(localStorage.getItem(localStorageKey)) || ["Dallas, TX", "New York,NY", "Los Angeles, CA", "Seattle, WA", "Chicago, IL","Goa, India","Maui, Hawaii", "Agra, India","Delhi,india"];
